...
/**
 * Use mock web service (based on the now-defunct Google Base) with specified criteria to obtain Review data.
 * 
...
public class ReviewFetcher {
    ...
    private static final String QBASE = "https://cn.bing.com/search?q=";
    ...
    public ReviewFetcher(String loc, String description, String rat, int start, int numResults) {
        ...
        if ((location != null) && !location.equals("")) {
            this.query +=location ;//(ReviewFetcher.QL_PREFIX + location);
        }
        /*
    ...
    public ArrayList<Review> getReviews() {
        ...
        try {
            ...
            Log.e(Constants.LOGTAG,"sssssssss: "+this.query);
